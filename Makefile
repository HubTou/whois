...
man/c${NAME}.1.gz: man/${NAME}.1.gz
	@ln man/${NAME}.1.gz man/c${NAME}.1.gz

man/c${NAME}.3.gz: man/${NAME}.3.gz
	@ln man/${NAME}.3.gz man/c${NAME}.3.gz

package: man/${NAME}.1.gz man/${NAME}.3.gz man/c${NAME}.1.gz man/c${NAME}.3.gz
	python -m build
...
distclean:
	rm -rf build dist src/*.egg-info man/${NAME}.1.gz man/${NAME}.3.gz man/c${NAME}.1.gz man/c${NAME}.3.gz
